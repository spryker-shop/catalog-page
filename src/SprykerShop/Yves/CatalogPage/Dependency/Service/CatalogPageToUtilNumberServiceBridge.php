...
namespace SprykerShop\Yves\CatalogPage\Dependency\Service;

use Generated\Shared\Transfer\NumberFormatConfigTransfer;

class CatalogPageToUtilNumberServiceBridge implements CatalogPageToUtilNumberServiceInterface
{
    /**
